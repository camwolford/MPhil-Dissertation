### Re-perform MR ###
# This script was used to re-perform MR on the metabolites that failed the PwCoCo analysis.
library(tidyverse)
library(stringr)
...
# Add metabolites with IVW_Pval > 3.004807e-5 to metabolite_t2dm_coloc_fail_remove
metabolite_t2dm_coloc_fail_remove <- rbind(metabolite_t2dm_coloc_fail_remove, metabolite_t2dm_coloc_fail %>% filter(IVW_Pval > 3.004807e-5))
...
# Add metabolites with IVW_Pval > 3.004807e-5 to metabolite_fg_coloc_fail_remove
metabolite_fg_coloc_fail_remove <- rbind(metabolite_fg_coloc_fail_remove, metabolite_fg_coloc_fail %>% filter(IVW_Pval > 3.004807e-5))
...
# Add metabolites with IVW_Pval > 3.004807e-5 to metabolite_hba1c_coloc_fail_remove
metabolite_hba1c_coloc_fail_remove <- rbind(metabolite_hba1c_coloc_fail_remove, metabolite_hba1c_coloc_fail %>% filter(IVW_Pval > 3.004807e-5))
